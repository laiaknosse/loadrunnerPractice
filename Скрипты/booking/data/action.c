Action()
{
	...
	web_submit_data("login.pl", 
		...
		"Mode=HTML", 
		ITEMDATA, 
		"Name=userSession", "Value=137696.717861482HAicHHtpQcftctQzpztQff", ENDITEM, 
	...
	web_submit_data("reservations.pl", 
		...
		"Name=departDate", "Value=11/14/2023", ENDITEM, 
		"Name=arrive", "Value=Seattle", ENDITEM, 
		"Name=returnDate", "Value=11/15/2023", ENDITEM, 
	...
	web_submit_data("reservations.pl_3", 
		...
		"Name=address1", "Value=Some st. 18", ENDITEM, 
		"Name=address2", "Value=London", ENDITEM, 
		"Name=pass1", "Value=Jojo Bean", ENDITEM, 
		"Name=creditCard", "Value=11111111111", ENDITEM, 
